...
import { TbCoins, TbLeaf, TbHeartHandshake, TbBoxSeam } from 'react-icons/tb';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col items-center">
            <TbBoxSeam className="h-12 w-12 text-[#609966] my-2"/>
          ...
          <div className="flex flex-col items-center">
            <TbHeartHandshake className="h-12 w-12 text-[#609966] my-2"/>
            {/* <svg className="h-8 w-8 text-blue-500 mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex flex-col items-center">
            <TbLeaf className="h-12 w-12 text-[#609966] my-2"/>
            {/* <svg className="h-8 w-8 text-blue-500 mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex flex-col items-center">
            <TbCoins className="h-12 w-12 text-[#609966] my-2"/>
            {/* <svg className="h-8 w-8 text-blue-500 mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">

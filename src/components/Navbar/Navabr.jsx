        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center">
              <a href="#home" className="px-3 py-2 text-white hover:bg-gray-700 rounded-md">Home</a>
              <a href="#about" className="px-3 py-2 text-white hover:bg-gray-700 rounded-md">About</a>
              <a href="#services" className="px-3 py-2 text-white hover:bg-gray-700 rounded-md">Services</a>
              <a href="#contact" className="px-3 py-2 text-white hover:bg-gray-700 rounded-md">Contact</a>
            </div>
          </div>
